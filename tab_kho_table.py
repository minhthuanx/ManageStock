            ...
            with st.expander("Sao chép Auto Title", expanded=False):
                ...
                if _cp_filtered.empty:
                    ...
                    for _ci, (_, _crow) in enumerate(_cp_filtered.iterrows()):
                        ...
                        st.markdown(
                            f'<div style="font-size:0.8rem;color:#6b8a9e;margin-top:0.5rem;">'
                            f'STT <b style="color:#bc5090">{int(_crow["STT"])}</b> · '
                            f'{_crow["Tên Pet"]} · <span style="color:#bc5090">{_crow["Mutation"]}</span>'
                            f'</div>',
                        ...
                        with _ct2:
                            if _b64_desc:
                                ...
                                _cmp.html(
                                    ...
                                    'border-radius:8px;cursor:pointer;background:#e8e0e8;'
                                    'color:#00202e;font-weight:600;font-size:11px;">&#x1F47B; M&#xF4; t&#x1EA3;</button>'
                                    '<script>(function(){'
