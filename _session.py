...
from _database import (
    ...
    _load_pinned_resell_from_supabase,
)
...
def init_session():
    if "initialized" not in st.session_state:
        ...
        _sk_ph.markdown(
            ...
            '<div style="height:22px;width:38%;border-radius:6px;background:linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%);background-size:200% 100%;animation:_sk 1.4s infinite;"></div>'
            '<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0.55rem;margin:0.3rem 0;">'
            + ('<div style="height:68px;border-radius:10px;background:linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%);background-size:200% 100%;animation:_sk 1.4s infinite;"></div>' * 4) +
            '</div>'
            '<div style="height:130px;border-radius:10px;background:linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%);background-size:200% 100%;animation:_sk 1.4s infinite;"></div>'
            '<div style="height:13px;width:55%;border-radius:6px;background:linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%);background-size:200% 100%;animation:_sk 1.4s infinite;"></div>'
            '<div style="height:13px;width:75%;border-radius:6px;background:linear-gradient(90deg,#111827 25%,#1e293b 50%,#111827 75%);background-size:200% 100%;animation:_sk 1.4s infinite;"></div>'
            '</div>',
