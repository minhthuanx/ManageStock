...
def render_tab_chart(df, bulk_df, bulk_history):
    ...
    st.markdown(
        ...
        'background:linear-gradient(135deg,rgba(129,140,248,0.12),rgba(0,200,255,0.08));'
        ...
        'color:#64748b;font-weight:500;">Ngày bắt đầu</span>'
        f'<span style="font-size:0.88rem;font-weight:600;color:#a5b4fc;letter-spacing:0.02em;">{_start_date_str}</span>'
        '</div>',
